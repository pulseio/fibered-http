...
(function() {
  ...
  Request = (function() {
    ...
    Request.prototype.redirect = function(location, future) {
      var opt, redirectOptions, _i, _len, _ref,
        _this = this;
      if (Fiber.current) {
        redirectOptions = extend(this.options, {
          maxRedirects: this.options.maxRedirects - 1,
          url: location
        });
        _ref = ['host', 'hostname', 'path', 'port', 'protocol'];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          opt = _ref[_i];
          delete redirectOptions[opt];
        }
        return future["return"](new Request(redirectOptions).send());
      } else {
